...
void solve(){
    ...
    while(num1){
        if(num1%10 == 5 && temp_num1 == ""){
            temp_num1 = "5";
            num1 /= 10;
        }
        else if(num1%10 == 2 && temp_num1 == "5"){
            temp_num1 = "25";
            num1 /= 10;
        }
        else{
    ...
    while(num2){
        if(num2%10 == 0 && temp_num2 == ""){
            temp_num2 = "0";
            num2 /= 10;
        }
        else if(num2%10 == 0 && temp_num2 == "0"){
            temp_num2 = "00";
            num2 /= 10;
        }
        else{
    ...
    while(num3){
        if(num3%10 == 5 && temp_num3 == ""){
            temp_num3 = "5";
            num3 /= 10;
        }
        else if(num3%10 == 7 && temp_num3 == "5"){
            temp_num3 = "75";
            num3 /= 10;
        }
        else{
    ...
    while(num4){
        if(num4%10 == 0 && temp_num4 == ""){
            temp_num4 = "0";
            num4 /= 10;
        }
        else if(num4%10 == 5 && temp_num4 == "0"){
            temp_num4 = "50";
            num4 /= 10;
        }
        else{
